...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('penyewaan_detail', function (Blueprint $table) {
            ...
            $table->foreignId('penyewaan_detail_penyewaan_id')->constrained('penyewaan', 'penyewaan_id')->cascadeOnDelete()->cascadeOnUpdate();
            $table->foreignId('penyewaan_detail_alat_id')->constrained('alat', 'alat_id')->cascadeOnDelete()->cascadeOnUpdate();
